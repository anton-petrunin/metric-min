...
The disc retracts defined above can be also defined as the images of strong deformation retracts of $\DD$;
in this case the restriction of retraction to the boundary forms the corresponding boundary curve.
We will not need this statement, but it follows from Moore's quotient theorem quoted below. 

In this section $Y$ is an arbitrary metric space.
