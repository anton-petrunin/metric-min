...
Moreover, without loss of generality, %???BIT MORE EXPL???
we can assume that sides of each triangle do not overlap, 
if this is the case, we can remove the overlapping part and glue directly what comes to it from the sides.%???WE SHOULD DO SOMETHING WITH HAIR
