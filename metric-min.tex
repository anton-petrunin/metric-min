...
Let $X$ be a length space, $Y$ a metric spaces and $f\:X\to Y$ a continuous map. Then the following holds true.
\begin{itemize}
...
Let $X$ be a compact geodesic space, $Y$ a metric spaces and $f\:X\to Y$ a continuous map. Then $\|X\|_f$ is a geodesic space.
\end{thm}
\parit{Proof.}
...
Let $X$ be a compact geodesic space, $Y$ a metric spaces and $f\:X\to Y$ a continuous map. Let $c\:[0,1]\to|X|_f$ be a rectifiable
...
Let $X$ be a compact geodesic space, $Y$ a metric spaces and $f\:X\to Y$ a continuous map. Then
the inverse image of an open connected subset $C$ of $|X|_f$ under $\pi_f$ is pathconnected in $X$.
\end{thm}
\parit{Proof.}
...
\item  More precisely, $\bar f$ preserves the lengths of all curves $\pi_f(\gamma)$ with $\gamma$ a curve in $X$, see the following lemma.
\end{itemize}
