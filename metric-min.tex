...
\begin{abstract}
A surface which does not admit a metric decreasing deformation is called \emph{metric minimizing}.
...
Here is \emh{not a proof} of the statement above, try to guess where is the cheating.
