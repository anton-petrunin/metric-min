...
of $\Geod(W)$.
Assume $s\:\DD\to W$ is a map such that for any element $g$ in $\mathcal{G}$ every 
...
Note that the space $\Geod(W)$ of all geodesics in $W$ with endpoints on $\partial W$ is compact. 
Fix a dense sequence of geodesics $\gamma_1,\gamma_2,\dots$ in $\Geod(W)$.
