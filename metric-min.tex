...
contained in the $\epsilon$-neighborhood of $K$, i.e. $|s(x)-\pi\circ s(x)|<\epsilon$ for $x\in\Omega$.
...
Let $\gamma$ be a continuous circle in a CAT(0) space $X$. Then there is a unique energy minimizing disc $u$ which spans $\gamma$, i.e. $u$
