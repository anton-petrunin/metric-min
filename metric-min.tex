...
More precisely, (1) there is a metric $\rho$ on the disjoint union $\bm{X}=X_\infty\sqcup X_1\sqcup X_2\dots$ such that $\rho|_{X_\alpha}$ coinsides with the metric on $X_\alpha$ for any $\alpha\in\{\infty,0,1,\dots\}$ and $X_n$ converge to $X_\infty$ in the sense of Hausdorff as the subsets in $(\bm{X},\rho)$ and (2) the sequence of the compositions $\gamma_n\:\SS^1\to X_n \hookrightarrow\bm{X}$ converges to $\gamma_\infty\:\SS^1\to X_\infty \hookrightarrow\bm{X}$ pointwise.
