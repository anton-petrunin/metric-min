...
then the midpoint $m$ of $[pq]$ forms a degenerate geodesic in $\Geod(W)$ which separates $K$ from $p$.

To prove the last statement, 
note that the set of geodesics in $\Geod(W)$ which separates $K$ from $p$ is open. %!!!NOT quite true, but almost.
\qeds
