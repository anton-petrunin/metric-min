...
\parbf{An alternative definitions.}
...
the case that $|\DD|_s$ is  homeomorphic to disc and its boundary is rectifiable simple. 
...
Clearly the pair $h\:F\to W$ and $q\:W\to Y$ satisfies the condition above.
...
Pass to the ultralimit $q_\omega\:W\to Y^\omega$ and set $q=\pi\circ q_\omega$,
