...
Assume $s_0, s_1\:X\to Y$ be continuous and metric minimizing maps relative to $A$
and $\|{*}-{*}\|_{s_0}=\|{*}-{*}\|_{s_1}$.
Then $s_0=s_1$.
\end{thm}
...
Let $A'\subset X$ be the maximal subset which is  the inverse image of component of $A$ in $\|X\|_{s_0}$
Since the spaces $\|X\|_{s_0}$ and $\|X\|_{s_1}$ are connected, the statement follows.
