...
An example of disc retract which is not a disc is shown on the picture;
...
In \cite{St}, the second author used them to control the mapping behaviour of minimal surfaces (minimal discs).  
...
It gives a criterion which allows to extend maps from subsets
