...
An example of a disc retract which is not a disc is shown on the picture;
...
In \cite{St}, the second author used them in the proof a $\CAT(0)$ version of the Fary-Milnor theorem to control the mapping behaviour of minimal surfaces (minimal discs).  
