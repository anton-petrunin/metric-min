...
%\usepackage{showkeys}
\hypersetup{pdftitle={Metric minimzing surfaces revisited},
...
This will be useful later on, when we approximate metric minimizing maps.
It allows us to pass to the limit .
