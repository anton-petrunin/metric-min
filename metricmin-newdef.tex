...
$s$ on $\partial \DD$ and fulfills 
\[\length s\circ\gamma\ge \length s'\circ\gamma\]
for all curves $\gamma$ in $\DD$, then the equality holds for all curves $\gamma$.
...
The class of metric minimizing discs contain many well-studied disc-type maps in metric geometry.
...
Let us list few applications of metric minimizing surfaces.
...
In \cite{St}, the second author used it to control the mapping behaviour of minimal surfaces (minimal discs).  
