...
By smoothing this example one can produce a smooth disc which is not metric minimizing, but \emph{strictly saddle} meaning the principal curvatures at each interior point have opposite signs. %??? not longer sure --- maybe not strictly...
