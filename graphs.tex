...
$X$ a compact metric space and $A$ a subset of $X$.

Given a Lipschitz continuous map $f\:X\to Y$ there is a metric minimizing map $h\:\Gamma\to Y$
such that $f\succcurlyeq h\rel A$.
\end{thm}

\parit{Proof.}
Let $\mathcal{O}$ be a well-ordered subset with respect to ``$\succcurlyeq\rel A$'' containing $f$. 
