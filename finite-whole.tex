...
a closed nonempty set $\mathfrak{S}_F$ of maps  $F\to Y$ is given, such that
\begin{itemize}
...
We can choose a good map $f$ which has the maximal domain $A$ with respect to inclusion;
that is, we can not enlarge the domain of $f$ by a single point while keeping it good.
