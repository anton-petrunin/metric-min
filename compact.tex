...
which restricts to the given metric on each $X_\alpha, \alpha\in\{0,1,\dots,\infty\}$, 
...
converges to $\gamma_\infty\:\SS^1\to X_\infty \hookrightarrow\bm{X}$ pointwise.
\end{enumerate}
...
In the following $\area K$ will denote the two-dimensional Hausdorff measure of a metric space $K$. 
...
and there is a path $c$ connecting 
